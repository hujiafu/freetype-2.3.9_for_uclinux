...
#
CPPFLAGS := 
CFLAGS   := -c  -I. -I/usr/local/minigui/cross/arm/cortex-m3/include -mcpu=cortex-m3 -mthumb -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS := -L/usr/local/minigui/cross/arm/cortex-m3/lib -lz
